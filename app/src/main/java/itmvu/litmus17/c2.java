...
public class c2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Firebase.setAndroidContext(this);
        ...
        myFirebaseRef.child("Sports/s2/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(c2.this, R.style.AppCompatAlertDialog);
