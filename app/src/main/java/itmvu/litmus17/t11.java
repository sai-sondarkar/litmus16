...
public class t11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Firebase.setAndroidContext(this);
        ...
        myFirebaseRef.child("Technovision/t11/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(t11.this, R.style.AppCompatAlertDialog);
