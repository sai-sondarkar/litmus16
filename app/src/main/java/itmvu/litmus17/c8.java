...
public class c8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRef.child("Sports/s8/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(c8.this, R.style.AppCompatAlertDialog);
