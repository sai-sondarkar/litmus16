...
public class m7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRef.child("Magnif/m7/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(m7.this, R.style.AppCompatAlertDialog);
