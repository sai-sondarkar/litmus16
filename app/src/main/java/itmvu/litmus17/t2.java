...
//        Firebase.getDefaultConfig().setPersistenceEnabled(true);
        ...
        myFirebaseRef.child("Technovision/t2/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(t2.this, R.style.AppCompatAlertDialogStyle);
        builder.setTitle("Location");
        builder.setMessage("Computer Lab 1 , Main Building , ITM Vocaional University ");
