...
public class t12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Firebase.setAndroidContext(this);
        ...
        myFirebaseRef.child("Technovision/t12/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(t12.this, R.style.AppCompatAlertDialog);
