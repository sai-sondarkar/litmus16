...
public class m1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Firebase.setAndroidContext(this);
        ...
        myFirebaseRef.child("Magnif/m1/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(m1.this, R.style.AppCompatAlertDialog);
