...
public class c4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRef.child("Sports/s4/GirlsGullyCricket_magnif").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void loc (View view)
    {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(c4.this, R.style.AppCompatAlertDialog);
