...
public class RegisterSports extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//sports main
    ...
    private class PostDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        private ProgressDialog dialog = new ProgressDialog(RegisterSports.this);
